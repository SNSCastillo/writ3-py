# Tu tarea es extender ligeramente las capacidades de la clase Queue. 
# Queremos que tenga un método sin parámetros que devuelva True si la cola está vacía y False de lo contrario.
